   ...
   private static final String TABLE_CREATE =
    ...
    public void insertDummyDiaryData() {
        ...
        insertDiary(new Diary(
                0,
                "2024-10-28",
                "새로운 주가 시작되어 힘차게 복습으로 하루를 마무리했다. 처음 배운 내용들이 쌓여 가는 만큼 복습을 통해 기억이 다시 선명해지고, 작은 성취감도 느껴졌다. 내일은 아침 운동과 영어 회화 연습도 함께 챙기면서 좀 더 체계적으로 하루를 보내려 한다.",
                "",
                false,
                "배운 내용 복습",
                ""
        ...
        insertDiary(new Diary(
                0,
                "2024-10-29",
                "오늘은 아침에 일찍 일어나 운동으로 시작했다. 오랜만에 운동을 하고 나니 개운했지만, 하루를 보내면서 약간의 피로도 느껴졌다. 그래도 영어 회화 연습도 해내면서 계획한 일들을 충실히 지켰다는 생각에 뿌듯했다. 다만, 시간이 부족해 복습을 미뤄야 했던 점이 아쉬웠다. 내일은 꼭 복습까지 완료해서 하루를 온전히 채워 볼 것이다.",
                "",
                false,
                "아침 운동@영어 회화 연습",
                "배운 내용 복습"
        ...
        insertDiary(new Diary(
                0,
                "2024-10-31",
                "오늘은 아침 운동을 하려 했지만, 알람을 무시하고 더 자버렸다. 조금 아쉽긴 하지만, 영어 회화 연습과 복습은 끝까지 챙겼다. 특히 영어 연습을 할 때 문장을 조금 더 자연스럽게 말할 수 있었던 것 같아 성취감을 느꼈다. 복습할 때는 지난 내용이 다시 기억나는 게 공부에 큰 도움이 되었다. 내일은 아침 운동을 다시 한번 시도하면서 모든 계획을 다 지켜보려고 한다.",
                "",
                false,
                "영어 회화 연습@배운 내용 복습",
                "아침 운동"
        ...
        insertDiary(new Diary(
                0,
                "2024-11-2",
                "오늘은 아침 운동이랑 복습은 했지만, 영어 회화 연습은 놓쳤어. 아침 운동 끝내고 기분은 좀 나아졌는데, 사실 기말고사를 망쳐서 하루 종일 우울했어. 복습하면서 조금이라도 보충하려고 했지만, 뭔가 부족한 느낌이 계속 들어. 다음엔 더 잘해야지 하고 마음 다잡아보려 했지만 쉽지 않네. 영어 연습도 놓친 게 신경 쓰여서 더 답답한 하루였어.",
                "",
                false,
                "아침 운동@배운 내용 복습",
                "영어 회화 연습"
